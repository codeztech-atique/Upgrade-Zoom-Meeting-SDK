...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./lib/css/react-select.css" />
...
<body>
            ...
            <div id="navbar" class="websdktest">
                <form class="navbar-form navbar-right" id="meeting_form">
                    <div class="form-group">
                        <input type="text" name="display_name" id="display_name" value="2.18.2#CDN" maxLength="100"
    ...
    <script src="./lib/js/redux.min.js"></script>
    <script src="./lib/js/redux-thunk.min.js"></script>
    <script src="./lib/js/lodash.min.js"></script>
    <script src="./lib/js/zoom-meeting-3.1.6.min.js"></script>
